...
contract ClaimAllFuzz is Setup {
    ...
    function test_ShouldBeAbleToClaimAllOnL2_WhenBuyBackFromL1Fails(uint256 tokenToBurnAmount) public {
    ...
    function test_ShouldBeAbleToAccountCorrectly_WhenBuyBackOnL2IsDone_AfterFailedBuyBackFromL1(
        ...
        uint256 expectedBuyTokenAmount1 = (tokenToBurnAmount2 * exchangePrice) / buyTokenPrice;
        ...
        uint256 expectedBuyTokenAmount2 = (tokenToBurnAmount1 * exchangePrice) / buyTokenPrice;
