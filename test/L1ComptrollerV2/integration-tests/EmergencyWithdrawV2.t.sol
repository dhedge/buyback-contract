...
contract EmergencyWithdrawV2 is SetupV2 {
    ...
    function test_ShouldBeAbleToEmergencyWithdraw_PartialAmounts() public {
        ...
        deal(address(pepe), address(L1ComptrollerV2Proxy), 1000e18);

        vm.prank(admin);

        // Withdraw a partial amount of PEPE tokens.
        L1ComptrollerV2Proxy.emergencyWithdraw(address(pepe), 100e18);
        ...
        assertEq(
            900e18,
            pepe.balanceOf(address(L1ComptrollerV2Proxy)),
    ...
    function test_ShouldBeAbleToEmergencyWithdraw_FullAmount() public {
        ...
        L1ComptrollerV2Proxy.emergencyWithdraw(address(pepe), type(uint256).max);
